...
def drawPolygon(t, 4, 10):
	...
	return vertices #remeber and store the list of vertices
...
# 	v = drawPolygon(T, n, 16) # 50-sided, with each side = 50 steps long
...
# 			nextVertex = (current * 41)%n # using a different multiplier will change the shape!
